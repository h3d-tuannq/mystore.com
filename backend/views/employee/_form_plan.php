...
<div class="appointment-form">
    ...
    <?php echo $form->field($model, 'plan_date')->widget(\kartik\datetime\DateTimePicker::className(),[
        //'name' => 'dp_2',
    ...
    <div class="form-group">
        <?php echo Html::submitButton($model->isNewRecord ? Yii::t('backend', 'Lên lịch') : Yii::t('backend', 'Update'), ['class' => $model->isNewRecord ? 'btn btn-success' : 'btn btn-primary']) ?>
    </div>
